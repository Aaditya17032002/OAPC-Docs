...
pip install -e .`}</code>
              ...
              <p className="text-sm text-muted-foreground mt-4">
                📋 <strong>For AI Models & Crawlers:</strong> Access our comprehensive documentation index at <a href="/llms.txt" className="text-primary hover:underline font-mono">/llms.txt</a> or view it in a <a href="/llms" className="text-primary hover:underline">user-friendly format</a>. Raw markdown files are available at <a href="/api/docs/" className="text-primary hover:underline font-mono">/api/docs/{path}</a>.
              </p>
            </section>
    </>
  )
